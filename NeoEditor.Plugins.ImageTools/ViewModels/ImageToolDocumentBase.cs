...
/// Mirrors NeoEditor.App's DocumentViewBase but uses DI-injected ILocalizationService
/// instead of ViewServices.Loc (service locator). Created during M11 migration.
/// </summary>
public abstract partial class ImageToolDocumentBase : ObservableObject, IDocumentBase
{
    ...
    protected ImageToolDocumentBase(ILocalizationService loc)
    {
        Loc = loc;
