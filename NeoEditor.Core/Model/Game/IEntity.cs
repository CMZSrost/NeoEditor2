...
public class IEntity
{
    ...
    /// <summary>Merge-view auto-incremented ID. Defaults to 0; set by merge-store builder.</summary>
    [NotMapped]
    ...
    {
        var uidKeyAttr = GetType().GetCustomAttribute<UIDKeyAttribute>();
        var keyName = uidKeyAttr?.PropertyNames?.FirstOrDefault(n => n != nameof(EntityId));
