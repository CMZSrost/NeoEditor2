package org.flixel
{
   ...
   public class FlxSound extends FlxBasic
   {
      ...
      public function play(param1:Boolean = false, param2:Number = 0) : void
      {
         ...
         if(param1)
         {
            _loc3_ = this.autoDestroy;
            this.autoDestroy = false;
            this.stop();
            this.autoDestroy = _loc3_;
         }
         else if(param2 != 0)
         {
      ...
      public function fadeIn(param1:Number, param2:Number = 0) : void
      {
         this._fadeOutTimer = 0;
         this._fadeInTimer = param1;
         this._fadeInTotal = this._fadeInTimer;
         this._volumeAdjust = 0;
         this.updateTransform();
         this.play(false,param2);
      }
      ...
      protected function gotID3(param1:Event = null) : void
      {
         ...
         if(this._sound.id3.songName != null && this._sound.id3.songName.length > 0)
         {
            this.name = this._sound.id3.songName;
         }
         if(this._sound.id3.artist != null && this._sound.id3.artist.length > 0)
         {
