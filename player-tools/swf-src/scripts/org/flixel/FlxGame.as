package org.flixel
{
   ...
   public class FlxGame extends Sprite
   {
      ...
      protected function create(param1:Event) : void
      {
         ...
         stage.addEventListener(MouseEvent.RIGHT_MOUSE_DOWN,this.onRightMouseDown);
         stage.addEventListener(MouseEvent.RIGHT_MOUSE_UP,this.onRightMouseUp);
         stage.addEventListener(MouseEvent.MOUSE_WHEEL,this.onMouseWheel);
         stage.addEventListener(MouseEvent.DOUBLE_CLICK,this.onDoubleClick);
