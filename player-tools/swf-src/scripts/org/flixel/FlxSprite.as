package org.flixel
{
   ...
   public class FlxSprite extends FlxObject
   {
      ...
      public function loadBitmap(param1:BitmapData, param2:Boolean = false, param3:Boolean = false, param4:uint = 0, param5:uint = 0, param6:Boolean = false) : FlxSprite
      {
         this._bakedRotation = 0;
         this._pixels = param1;
         if(param3)
      ...
      public function drawLine(param1:Number, param2:Number, param3:Number, param4:Number, param5:uint, param6:uint = 1) : void
      {
         ...
         var _loc8_:Number;
         if((_loc8_ = Number(param5 >> 24 & 0xFF) / 255) <= 0)
         {
            _loc8_ = 1;
         }
      ...
      public function replaceColor(param1:uint, param2:uint, param3:Boolean = false) : Array
      {
         ...
         var _loc5_:uint = 0;
         var _loc7_:uint = uint(this._pixels.height);
         var _loc8_:uint = uint(this._pixels.width);
         while(_loc5_ < _loc7_)
         {
            _loc6_ = 0;
            while(_loc6_ < _loc8_)
      ...
      public function Zoom(param1:Number) : void
      {
         ...
         this.pixels = GUIValues.ScaleBitmapData(this.pixels,param1 / this.fZoom);
         this.fZoom = param1;
      }
   }
}
