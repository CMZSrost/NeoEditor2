...
public partial class SearchPaneViewModel : ViewModelBase
{
    ...
    public SearchPaneViewModel(ISearchService searchService, DataTableService dataTable)
    {
    ...
    private void NavigateToResult(SearchResultItem? item)
    {
        ...
        _dataTable.NavigateToByEntityId(item.EntityType, item.Entity.EntityId);
    }
}
