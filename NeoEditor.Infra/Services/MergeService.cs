...
public interface IMergeService
{
    Task<MergeResult> ComputeMergeAsync(
        ...
        Dictionary<int, string> modIdToNamespace,
...
public class MergeService : IMergeService
{
        ...
        Dictionary<int, string> modIdToNamespace)
    {
        ...
        // Build dir→ns reverse mapping from namespaceToModName,
        // then fall back to modIdToNamespace (strModName from profile)
        // to avoid using mod directory name as namespace.
        ...
        foreach (var (entity, _, _, _) in allItems)
        {
            var ns = entity.ModId == -1 ? "0"
                ...
                : modIdToNamespace.TryGetValue(entity.ModId, out var rn) ? rn
