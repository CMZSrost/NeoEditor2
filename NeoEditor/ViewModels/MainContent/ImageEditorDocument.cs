...
public partial class ImageEditorDocument : DocumentViewBase
{
    ...
    public ImageEditorDocument() : this(App.ServiceProvider.GetRequiredService<IImageEditorProcessingService>())
    {
    }
    ...
    public async Task PixelateImage()
    {
        ...
        try
        {
            var processed = await _processingService.CreatePreviewAsync(request);
