...
public partial class battlemove
{
    [Key]
    ...
    public byte? bAllOutOfRange { get; set; }

    [Column(TypeName = "tinyint(1)")]
    public byte? bInAttackRange { get; set; }
    ...
    [Column(TypeName = "tinyint(1)")]
    public byte? bApproach { get; set; }

    [Column(TypeName = "tinyint(1)")]
    public byte? bOffense { get; set; }

    [Column(TypeName = "tinyint(1)")]
    public byte? bFallBack { get; set; }

    [Column(TypeName = "tinyint(1)")]
    public byte? bRetreat { get; set; }

    [Column(TypeName = "tinyint(1)")]
    public byte? bPosition { get; set; }

    [Column(TypeName = "tinyint(1)")]
    public byte bPassive { get; set; }
}
