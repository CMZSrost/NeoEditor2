...
public class chargeprofile
{
    ...
    [Column(TypeName = "varchar(12)")] public string strItemID { get; set; } = null!;

    [Column(TypeName = "float")] public double fPerUse { get; set; }

    [Column(TypeName = "float")] public double fPerHour { get; set; }

    [Column(TypeName = "float")] public double fPerHourEquipped { get; set; }

    [Column(TypeName = "float")] public double fPerHex { get; set; }

    [Column(TypeName = "tinyint(1)")] public byte bDegrade { get; set; }
}