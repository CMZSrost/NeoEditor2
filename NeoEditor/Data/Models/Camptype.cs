...
public class camptype
{
    ...
    [Column(TypeName = "varchar(255)")] public string vImageList { get; set; } = null!;

    [Column(TypeName = "varchar(255)")] public string aCapacities { get; set; } = null!;

    public int nTreasureID { get; set; }

    [Column(TypeName = "float")] public double m_fAlertness { get; set; }

    [Column(TypeName = "float")] public double m_fVisibility { get; set; }

    [Column(TypeName = "float")] public double WetTempAdjustMod { get; set; }

    [Column(TypeName = "float")] public double m_fHealPerHourMod { get; set; }

    [Column(TypeName = "float")] public double fSleepQuality { get; set; }
}