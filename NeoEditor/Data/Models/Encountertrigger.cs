...
public partial class encountertrigger
{
    [Key]
    ...
    public byte bLocBased { get; set; }

    [Column(TypeName = "tinyint(1)")]
    public byte bDateBased { get; set; }

    [Column(TypeName = "tinyint(1)")]
    public byte bHexBased { get; set; }

    [Column(TypeName = "tinyint(1)")]
    public byte bUnique { get; set; }

    [Column(TypeName = "tinyint(1)")]
    public byte bAIPassable { get; set; }
