...
public class hextype
{
    ...
    [Column(TypeName = "tinyint(1)")] public byte bPassable { get; set; }
    ...
    [Column(TypeName = "varchar(255)")] public string vLightLevels { get; set; } = null!;
    ...
    [Column(TypeName = "varchar(255)")] public string vCondIDs { get; set; } = null!;
}