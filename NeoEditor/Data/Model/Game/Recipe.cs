...
public class Recipe
{
    [Display(Name = "Recipe_ModId")] public int ModId { get; set; }

    [Key]
    [Column("nID")]
    [Comment("代码标号")]
    [Display(Name = "Recipe_Id")]
