...
public class ItemType
{
    ...
    [Column("strDescAlt", TypeName = "varchar(255)")]
    [StringLength(255)]
    ...
    [Column("vDegradeTreasureIDs", TypeName = "varchar(255)")]
    [StringLength(255)]
