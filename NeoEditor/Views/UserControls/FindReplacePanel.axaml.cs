...
public partial class FindReplacePanel : UserControl
{
    ...
    internal CommandHistory? CommandHistory { get; set; }
    internal Action? OnDirtyChanged { get; set; }
    ...
    private void OnReplaceAllClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        ...
        RefreshGrid();
        Hide();
        App.Notification.ShowSuccess(string.Format(Loc["FindReplaceSuccess"], edits.Count), Loc["FindReplaceTitle"]);
    }
